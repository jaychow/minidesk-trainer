...
@section('content')
        ...
        <div class="auth-wrapper d-flex no-block justify-content-center align-items-center">
            <div class="auth-box" style="background: black">
                <div id="loginform">
                    <div class="logo">
                        <span class="db"><i class="fa fa-users" style="font-size: 50px; color: orangered"></i></span>
                        <h5 class="font-medium m-b-20">Sign In as Admin</h5>
                    </div>
                    <!-- Form -->
                    <div class="row">
                        <div class="col-12">
                            <form class="form-horizontal m-t-20" method="POST" action="{{ route('admin.login.submit') }}" aria-label="{{ __('Login') }}">
                                @csrf
                                {{$errors->has('email')}}
